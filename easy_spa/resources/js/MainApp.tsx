          ...
          element={
            <ProtectedRoute role="WebMaster">
              <Routes>
                ...
                <Route path="spas/:slug/services/:serviceSlug" element={<WebmasterShowService />} />
                ...
                <Route path="spas/:spaSlug/employees/:employeeId/schedule" element={<WebMasterEmployeeSchedule />} />
