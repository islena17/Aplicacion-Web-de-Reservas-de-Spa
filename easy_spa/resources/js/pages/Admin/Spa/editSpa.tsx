...
import { useSpaForm } from '@/hooks/Admin/Spa/useSpaForm';

export default function AdminEditSpa() {
        ...
        <div className="container py-4 py-lg-5">
          <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
              ...
              <p className="text-muted mb-0">Modifica la información de tu spa.</p>
            </div>
              ...
              <form onSubmit={(e) => updateSpa(e, slug)}>
                <div className="row g-4">
                  <div className="col-12 col-md-6">
                    ...
                    />
                    {errors.name && <div className="invalid-feedback">{fieldError(errors.name)}</div>}
                  </div>
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.slug && <div className="invalid-feedback">{fieldError(errors.slug)}</div>}
                  </div>
                  ...
                  <div className="col-12">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.address && <div className="invalid-feedback">{fieldError(errors.address)}</div>}
                  </div>
                  ...
                  <div className="col-12 col-md-4">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.city && <div className="invalid-feedback">{fieldError(errors.city)}</div>}
                  </div>
                  ...
                  <div className="col-12 col-md-4">
                    ...
                    />
                    {errors.postal_code && (
                      <div className="invalid-feedback">{fieldError(errors.postal_code)}</div>
                    )}
                  </div>
                  ...
                  <div className="col-12 col-md-4">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.phone && <div className="invalid-feedback">{fieldError(errors.phone)}</div>}
                  </div>
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.email && <div className="invalid-feedback">{fieldError(errors.email)}</div>}
                  </div>
                  ...
                  <div className="col-12 col-md-3">
                    ...
                    />
                    {errors.opening_time && (
                      <div className="invalid-feedback">{fieldError(errors.opening_time)}</div>
                    )}
                  </div>
                  ...
                  <div className="col-12 col-md-3">
                    ...
                    />
                    {errors.closing_time && (
                      <div className="invalid-feedback">{fieldError(errors.closing_time)}</div>
                    )}
                  </div>
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.logo && <div className="invalid-feedback">{fieldError(errors.logo)}</div>}
                  </div>
